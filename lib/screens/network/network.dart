...
import 'package:issue_submission_interface/screens/network/network_final_details.dart';

class network extends StatefulWidget {
  final String category;
  const network({super.key, required this.category});
        ...
        child: SizedBox(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
      BoxShadow(
        color: Colors.grey.withValues(alpha: 0.3), // Shadow color with transparency
                    ...
                    onPressed: _isButtonEnabled
                        ? () {
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => NetworkFinalDetails(

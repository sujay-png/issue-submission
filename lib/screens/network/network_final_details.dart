...
import 'package:issue_submission_interface/screens/network/network_create_ticket.dart';
import 'package:issue_submission_interface/service/firebase_service.dart';

class NetworkFinalDetails extends StatefulWidget {
  final String brandmodel;
  final String category;
  const NetworkFinalDetails({
    super.key,
  ...
  @override
  State<NetworkFinalDetails> createState() => _NetworkFinalDetailsState();
}

class _NetworkFinalDetailsState extends State<NetworkFinalDetails> {
                  ...
                  if (_hasInvoice) ...[
                    ...
                    _imageUploadButton(
                      label: _invoiceImage == null
                          ...
                          : 'Invoice Attached',
                      onPressed: () async {
                        final pickedFile = await _firebaseService
                            .pickImageFromGallery();
                      ...
                      _dbService.submitOtherTicket(
                          ...
                          onSuccess: (ticketId) {
                            Navigator.pushReplacement(
                              ...
                              MaterialPageRoute(
                                builder: (context) =>
                                    NetworkCreateTicket(ticketId: ticketId),
                              ),
                            );
                          },

...
import 'package:issue_submission_interface/screens/printer/createprinter.dart';
import 'package:issue_submission_interface/service/firebase_service.dart';

class PrinterFinalDetails extends StatefulWidget {
  final String brandmodel;
  final String category;
  const PrinterFinalDetails({
    super.key,
  ...
  @override
  State<PrinterFinalDetails> createState() => _PrinterFinalDetailsState();
}

class _PrinterFinalDetailsState extends State<PrinterFinalDetails> {
  ...
  //save ticket details to firebase
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (_hasInvoice) ...[
                    ...
                    _imageUploadButton(
                      label: _invoiceImage == null
                          ...
                          : 'Invoice Attached',
                      onPressed: () async {
                        final pickedFile = await _dbService
                            .pickImageFromGallery();
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    items: ['Bangalore', 'Mangaluru', 'Udupi']
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        _dbService.submitPrinterTicket(
                          context: context,
                          isMounted: mounted,
                          ...
                          onSuccess: (ticketId) {
                            Navigator.pushReplacement(
                              ...
                              MaterialPageRoute(
                                builder: (context) =>
                                    CreateTicket(ticketId: ticketId),
                              ),
                            );
                          },
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                Createprinter(ticketId: generatedId),
                          ),
                        );
                      },

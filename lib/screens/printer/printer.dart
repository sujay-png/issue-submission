...
import 'package:issue_submission_interface/screens/printer/printer_final_details.dart';

class Printer extends StatefulWidget {
  final String category;
  const Printer({super.key, required this.category});
                    ...
                    onPressed: _isButtonEnabled
                        ? () {
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => PrinterFinalDetails(
